...
echo 8. Переключить фильтр айпи (%IPsetStatus%)
echo 9. Обновить список айпи
echo 0. Выйти
...
if "%ServiceStatus%"=="RUNNING" (
    ...
    echo Служба "%ServiceName%" НЕ АКТИВНА.
)
...
:: Разбор аргументов (объединить аргументы: 2=начальный параметр|3=аргумент со значением|1=аргументы параметров|0=по умолчанию)
set "args="
set "capture=0"
set "mergeargs=0"
set QUOTE="
