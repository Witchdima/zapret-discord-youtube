...
echo 5. Меню дианостики и тестирования 
echo 6. Меню проверки обновлений
echo 7. Переключить игровой фильтр (%GameFilterStatus%)
echo 8. Фильтры айпи
echo 0. Выйти
set /p menu_choice=Введите параметр (0-8): 
...
if "%menu_choice%"=="5" goto menu_diag
if "%menu_choice%"=="6" goto menu_update
...
set "menu_choice=null"
echo =========  Версия !LOCAL_VERSION!  =========
echo 1. Запустить диагностику
echo 2. Начать тестирование
echo 0. Выйти
set /p menu_choice=Введите параметр (0-2): 
...
set "menu_choice=null"
echo =========  Версия !LOCAL_VERSION!  =========
echo 1. Переключить проверку обновлений (%CheckUpdatesStatus%)
echo 2. Проверить обновления
echo 0. Выйти
set /p menu_choice=Введите параметр (0-8): 

if "%menu_choice%"=="1" goto check_updates_switch
if "%menu_choice%"=="2" goto service_check_updates
if "%menu_choice%"=="0" exit /b
goto menu
